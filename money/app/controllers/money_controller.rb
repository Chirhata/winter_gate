class MoneyController < ApplicationController
  ...
  before_action :ban_unset_target, {only: [:tomonth_target, :money_form_tomonth]}
  before_action :ban_set_target, {only: [:money_form_save, :money_form, :edit_target, :edit_target_save]}
  def money_form
